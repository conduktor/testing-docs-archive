...
Note that this document assumes you have configured Schema Registry when adding a Cluster to your workspace. If you have not done this step, please refer to [this](https://docs.conduktor.io/platform/console/schema-registry/#getting-started) section.
